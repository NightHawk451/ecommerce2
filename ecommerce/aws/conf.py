...
AWS_ACCESS_KEY_ID = os.environ.get("AWS_ACCESS_KEY_ID","AKIAID5FJOKXCO7PYKEA")
AWS_SECRET_ACCESS_KEY = os.environ.get("AWS_SECRET_ACCESS_KEY","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")
